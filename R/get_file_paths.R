...
get_file_paths <- function(source = c("bill tsvs","test sparse doc-term","raw text")){
    ...
    if(source == "raw text"){
        f1 <- system.file("extdata", "speech_1.txt", package = "SpeedReader")[1]
        f2 <- system.file("extdata", "speech_2.txt", package = "SpeedReader")[1]
