...
For many of the analyses we may wish to conduct with SpeedReader, you will need to start with a document-term matrix (DTM). 
...
* `num_match_blocks_v2` -- This statistic records the number of unique seuqnces of overlapping n-grams in document 2 that have a match in document 1.
